...
var W = (t, e, n) =>
	e in t ? P(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (t[e] = n);
...
function B() {
	...
	do {
		...
		for (a(null), i.length = 0, u = 0; S.length; ) S.pop()();
...
function K(t, e) {
	t.$$.dirty[0] === -1 && (i.push(t), q(), t.$$.dirty.fill(0)),
		...
		((o.ctx = n
			? n(t, e.props || {}, (c, w, ...k) => {
					...
					return (
						o.ctx &&
							f(o.ctx[c], (o.ctx[c] = v)) &&
							(!o.skip_bound && o.bound[c] && o.bound[c](v), x && K(t, c)),
						w
					);
			  })
			: []),
...
const X = '4';
typeof window < 'u' &&
	(window.__svelte || (window.__svelte = { v: /* @__PURE__ */ new Set() })).v.add(X);
function Y(t) {
	let e;
	return {
		c() {
